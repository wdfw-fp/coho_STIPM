...
oat_obs |> filter(pop_id == 34) |>
  select(mod, year, rtrn:`90%`, err:mase, in_10_90) |> 
  #gt(groupname_col = "year", rowname_col = "mod")
  gt(groupname_col = "mod", rowname_col = "year") |> 
