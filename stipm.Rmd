---
title: "stipm"
author: "dan.auerbach@dfw.wa.gov modifying DeFilippo et al. 2021"
date: "`r Sys.Date()`"
editor_options: 
...
tbl_coho <- tbl_coho |> 
  ...
  #so avoiding thatwhich presumably then gets removed later?
  left_join(
...
#unclear if the within-list "<-" declarations are intentional, opting for more locally scoped
#would prefer better within-list naming convention, but left as-is other than reorg around data types
list(
  ...
  dist = units::drop_units(sf::st_distance(coord)/10000), #values are identical
  ...
  MS_dat_x = tbl_coho_stan$MS$Fishery_Plus_Escapement,
