...
fit_stipm_86_17 <- stan_stipm(full = tbl_coho, year_min = 1986, year_max = 2017)
...
# #not yet run
# fit_stipm_98_17 <- stan_stipm(full = tbl_coho, year_min = 1998, year_max = 2017)
# 
# fit_stipm_98_17_smry <- fit_smry(fit_stipm_86_17, year_min = 1998)
...
stretch_ar1 <- set_names(2011:2012) |> 
  map(~stan_ar1(full = tbl_coho, one_ahead_year_min, .x))
