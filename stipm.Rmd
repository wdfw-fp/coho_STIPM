...
pop_meta <- readxl::read_excel("stipm_pops.xlsx") |>
  select(pop_id:hat, starts_with("FRAM_")) |>
  filter(FRAM_StockID != 13, FRAM_StockID != 43)

temp <- read_csv("data/postseason_fram_spwn_hvst_ests.csv")
